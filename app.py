...
def wishMe():
        ...
        if hour>=0 and hour<12:
            speak(" Good Morning my cutieepie ")
        elif hour>=12 and hour<16:
            speak("I love the way you are my sunshine")
        else:
            speak(" you are my fav girl ")
        speak("i am pallavi.please tell me how can i help you")
...
# Time
        ...
        # Exit
            ...
            speak("Goodbye Bbydoll! have a nice day")
            break
